...
import com.iltermon.expenselens.ui.components.DeleteWithReassignDialog
import com.iltermon.expenselens.ui.ExpenseLensViewModel
import com.iltermon.expenselens.ui.util.LocalCurrencySymbol
import com.iltermon.expenselens.ui.util.accountTypeLabel
...
private fun AccountManageRow(
    ...
    Row(
        ...
        Column(
            modifier = Modifier
                .weight(1f)
                // Gray out a disabled account so its inactive state reads at a glance.
